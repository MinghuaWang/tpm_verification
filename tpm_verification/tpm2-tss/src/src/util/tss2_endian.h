...
//#include <endian.h>
#include "endian.h" // modify by minghua. use "" instead of <>

// modify by minghua. add type for each of the following. 
#define HOST_TO_BE_16(value) htobe16((uint16_t)value)
#define HOST_TO_BE_32(value) htobe32((uint32_t)value)
#define HOST_TO_BE_64(value) htobe64((uint64_t)value)
#define BE_TO_HOST_16(value) be16toh((uint16_t)value)
#define BE_TO_HOST_32(value) be32toh((uint32_t)value)
#define BE_TO_HOST_64(value) be64toh((uint64_t)value)

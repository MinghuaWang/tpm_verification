...
/* 
    TIS verification cases 
*/

#include <tis_builtin.h>
#include <limits.h>

void tis_check_hash_functions() {
    TSS2_RC rc;
    IESYS_CRYPTO_CONTEXT_BLOB *context;
    uint8_t buffer[10] = {0};
    TPM2B tpm2b;
    ...
    /* use tis_xxx to initialize those variables. */
    rc = tis_unsigned_int_interval(0, UINT32_MAX);

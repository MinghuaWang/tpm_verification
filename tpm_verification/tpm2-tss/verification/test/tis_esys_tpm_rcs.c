...
/*
void tis_test_Certify(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_CertifyCreation(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_Quote(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_GetSessionAuditDigest(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_GetCommandAuditDigest(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_GetTime(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_Commit(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_EC_Ephemeral(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_VerifySignature(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_SetCommandCodeAuditStatus(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_Extend(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_Event(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_Read(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_Allocate(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_SetAuthPolicy(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_SetAuthValue(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PCR_Reset(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicySigned(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicySecret(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyTicket(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyOR(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyPCR(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyLocality(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyNV(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyCounterTimer(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyCommandCode(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyPhysicalPresence(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyCpHash(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
void tis_test_PolicyNameHash(void **state) {
    TSS2_RC r;
    TSS2_TCTI_CONTEXT *tcti;
    ESYS_CONTEXT *esys_context = (ESYS_CONTEXT *) * state;
    Esys_GetTcti(esys_context, &tcti);
...
int main(int argc, char **argv) {
    ...
    // tis_test_SelfTest(&state);
    // tis_test_IncrementalSelfTest(&state);
    // tis_test_GetTestResult(&state);

    // tis_test_StartAuthSession(&state);
    // tis_test_PolicyRestart(&state);
    // tis_test_Create(&state);
    // tis_test_Load(&state);
    // tis_test_LoadExternal(&state);
    // tis_test_ReadPublic(&state);

    // tis_test_ActivateCredential(&state);
    // tis_test_MakeCredential(&state);
    // tis_test_Unseal(&state);
    // tis_test_ObjectChangeAuth(&state);
    // tis_test_Duplicate(&state);
    // tis_test_Rewrap(&state);
    // tis_test_Import(&state);

    //tis_test_RSA_Encrypt(&state);
    // tis_test_RSA_Decrypt(&state);
    // tis_test_ECDH_KeyGen(&state);
    // tis_test_ECDH_ZGen(&state);
    // tis_test_ECC_Parameters(&state);
    // tis_test_ZGen_2Phase(&state);
    // tis_test_EncryptDecrypt(&state);
    // tis_test_EncryptDecrypt2(&state);
    // tis_test_Hash(&state);
    //tis_test_HMAC(&state);
   //  tis_test_GetRandom(&state);
   //  tis_test_StirRandom(&state);
     tis_test_HMAC_Start(&state);
     tis_test_HashSequenceStart(&state);
    // tis_test_SequenceUpdate(&state);
    // tis_test_SequenceComplete(&state);
    // tis_test_EventSequenceComplete(&state);
    /*
    tis_test_Certify(&state);
    tis_test_CertifyCreation(&state);
    tis_test_Quote(&state);
    tis_test_GetSessionAuditDigest(&state);
    tis_test_GetCommandAuditDigest(&state);
    tis_test_GetTime(&state);
    tis_test_Commit(&state);
    tis_test_EC_Ephemeral(&state);
    tis_test_VerifySignature(&state);
    tis_test_Sign(&state);
    tis_test_SetCommandCodeAuditStatus(&state);
    tis_test_PCR_Extend(&state);
    tis_test_PCR_Event(&state);
    tis_test_PCR_Read(&state);
    tis_test_PCR_Allocate(&state);
    tis_test_PCR_SetAuthPolicy(&state);
    tis_test_PCR_SetAuthValue(&state);
    tis_test_PCR_Reset(&state);
    tis_test_PolicySigned(&state);
    tis_test_PolicySecret(&state);
    tis_test_PolicyTicket(&state);
    tis_test_PolicyOR(&state);
    tis_test_PolicyPCR(&state);
    tis_test_PolicyLocality(&state);
    tis_test_PolicyNV(&state);
    tis_test_PolicyCounterTimer(&state);
    tis_test_PolicyCommandCode(&state);
    tis_test_PolicyPhysicalPresence(&state);
    tis_test_PolicyCpHash(&state);
    tis_test_PolicyNameHash(&state);
    */
    return 0;
}
